...
plotPath = DTDpath + '/Writeup/AASTEX_WRiteup/'
...
ages_edges_1, ages_edges_2 = 10**(ages_edges[:-1]), 10**(ages_edges[1:])
...
plt.errorbar(ages_cent, TRR_detect, yerr=(TRR_error_low, TRR_error_up), fmt='', ls='', lw=2.0, ecolor='k')
plt.errorbar(ages_cent, TRR_nondetect, yerr=TRR_nondetect*0.25, xerr=((ages_cent - ages_edges[:-1]), (ages_edges[1:] - ages_cent)), uplims=True, fmt='', ls='', ecolor='k', color='k')
